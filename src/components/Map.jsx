    ...
    return (
        ...
        <div onMouseLeave={close} className='relative w-full flex justify-center gap-0 flex-col '>
            ...
            {searching ? 
                ...
                : 
                <div onClick={chooseCurrentLocation} className={`bg-transparent absolute top-2 bottom-2 right-2 w-6 bg-contain bg-center bg-no-repeat bg-[url("/location.svg")] hover:cursor-pointer  ${currentLocationChoosen && 'bg-teal-200'}`}></div>
            }
